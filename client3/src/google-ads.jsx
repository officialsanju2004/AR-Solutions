...
const GoogleAdsManagement = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      `}</style>
<header className="w-full bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 py-4" data-aos="slide-down">
            <div className="mx-auto max-w-7xl px-4 ">
              <nav className="flex items-center justify-between rounded-2xl   bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-purple-500/30 px-4 sm:px-6 py-3 sm:py-4 shadow-md">
                ...
                {/* Menu - Desktop */}
                <ul className="hidden lg:flex items-center gap-4 text-white xl:gap-8 text-sm xl:text-[15px] font-medium c:\Users\hp\OneDrive\Documents\managed-hosting.jsx">
