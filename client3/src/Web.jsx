    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-12 fade-in">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Create stunning, high-performing websites that deliver exceptional user experiences and drive business growth.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gradient-to-br from-orange-100 to-red-100 rounded-2xl p-8 h-full">
            ...
            <div className="space-y-4">
              <div className="flex items-center bg-white rounded-lg p-4">
                <div className="text-orange-500 font-bold text-lg mr-4">1</div>
                <div>
                  <h4 className="font-semibold text-gray-900">Discovery & Planning</h4>
                  <p className="text-gray-600 text-sm">Understanding requirements and creating roadmap</p>
                </div>
              </div>
              <div className="flex items-center bg-white rounded-lg p-4">
                <div className="text-orange-500 font-bold text-lg mr-4">2</div>
                <div>
                  <h4 className="font-semibold text-gray-900">Design & Prototyping</h4>
                  <p className="text-gray-600 text-sm">Creating visual designs and interactive prototypes</p>
                </div>
              </div>
              <div className="flex items-center bg-white rounded-lg p-4">
                <div className="text-orange-500 font-bold text-lg mr-4">3</div>
                <div>
                  <h4 className="font-semibold text-gray-900">Development & Testing</h4>
                  <p className="text-gray-600 text-sm">Building, testing, and optimizing the website</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 service-card">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Modern Web Solutions</h2>
          <p className="text-gray-600 mb-6">
            We build websites that not only look beautiful but perform exceptionally well across all devices, 
            load quickly, and convert visitors into customers.
          </p>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              {technologies.map((tech, index) => (
                <span key={index} className={`px-4 py-2 rounded-full ${tech.color} font-medium`}>
                  {tech.name}
                </span>
              ))}
            </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div key={index} className="bg-white rounded-xl shadow-lg p-6 service-card">
            <h3 className="text-xl font-bold text-gray-900 mb-6">{service.category}</h3>
